...
import daniking.geoactivity.common.item.advanced.AdvancedShovelItem;
...
public final class GAObjects {
    ...
    private static AbstractBlock.Settings settings(final Material material, final float hardness, final float resistance) {
