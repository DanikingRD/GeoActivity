...
public class AutoSandstoneScreenHandler extends ItemScreenHandler {

    public AutoSandstoneScreenHandler( int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, GAInventory.create(ItemStack.EMPTY, 3));
    }

    public AutoSandstoneScreenHandler(int syncId, PlayerInventory playerInventory, GAInventory inventory) {
        super(GAScreenHandlerTypes.AUTO_SANDSTONE_BUILDER, syncId, playerInventory, inventory);
        this.builder()
                .playerSetup()
                .charge(80, 23)
