...
public class CoalRefinerScreen extends GuiBase<CoalRefinerScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        this.builder().drawSlot(matrices, this.left() + 30, slotPosY, ScreenBuilder.SlotType.DEFAULT);
        this.builder().drawSlot(matrices, this.left() + 70, slotPosY, ScreenBuilder.SlotType.DEFAULT);
        this.builder().drawOutputSlot(matrices, this.left() + 123, slotPosY - 4, ScreenBuilder.SlotType.DEFAULT);
