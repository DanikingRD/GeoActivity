...
public class ConversionCategory implements DisplayCategory<ConversionDisplay> {
    ...
    public static final Text TITLE = new TranslatableText("rei.daniking.geoactivity.conversion");
    ...
    public List<Widget> setupDisplay(ConversionDisplay display, Rectangle bounds) {
        ...
        final Text tooltip = new TranslatableText("rei.daniking.geoactivity.tooltip.builder", new TranslatableText(key.getString()));
