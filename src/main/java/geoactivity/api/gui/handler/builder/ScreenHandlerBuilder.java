...
public final class ScreenHandlerBuilder {
    ...
    private int startIndexOfContainer;
    ...
    public ScreenHandlerBuilder playerSetup(int posX, int posY) {
        ...
        this.startIndexOfContainer = this.parent.slots.size();
        return this;
    }
     ...
     */
    public void build() {
        this.parent.addContainerRange(Range.between(this.startIndexOfContainer, this.parent.slots.size() - 1));
    }
}
